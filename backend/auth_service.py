...
from .firebase_config import UNIQUE_USERNAMES_COLLECTION, USER_PROFILES_COLLECTION, EMAIL_OTPS_COLLECTION, UNIQUE_USERNAMES_COL, USER_PROFILES_COL, EMAIL_OTPS_COL, APP_ID
import random
import string
import time
import os
